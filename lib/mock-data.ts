...
export const INITIAL_CONVERSATIONS: Conversation[] = [
  ...
  { id: "c7", title: "英文合同条款翻译", agentId: "translator", messages: [], updatedAt: now - hour * 3 },
  { id: "c8", title: "产品发布会文案", agentId: "writer", messages: [], updatedAt: now - hour * 7 },
  { id: "c9", title: "隐私政策合规审查", agentId: "legal", messages: [], updatedAt: now - hour * 9 },
  { id: "c10", title: "现金流预测模型", agentId: "finance", messages: [], updatedAt: now - hour * 12 },
  { id: "c11", title: "招聘 JD 优化", agentId: "hr", messages: [], updatedAt: now - hour * 18 },
  { id: "c12", title: "社媒投放策略", agentId: "marketing", messages: [], updatedAt: now - hour * 20 },
  { id: "c13", title: "需求优先级排序", agentId: "product", messages: [], updatedAt: now - hour * 30 },
  { id: "c14", title: "登录页配色方案", agentId: "design", messages: [], updatedAt: now - hour * 33 },
  { id: "c15", title: "CI 流水线优化", agentId: "devops", messages: [], updatedAt: now - hour * 36 },
  { id: "c16", title: "越权漏洞排查", agentId: "security", messages: [], updatedAt: now - hour * 40 },
  { id: "c17", title: "慢查询索引优化", agentId: "database", messages: [], updatedAt: now - hour * 44 },
  { id: "c18", title: "退款话术模板", agentId: "customer-service", messages: [], updatedAt: now - hour * 47 },
  { id: "c19", title: "线性代数入门讲解", agentId: "education", messages: [], updatedAt: now - hour * 54 },
  { id: "c20", title: "作息与运动计划", agentId: "health", messages: [], updatedAt: now - hour * 58 },
  { id: "c21", title: "京都五日行程", agentId: "travel", messages: [], updatedAt: now - hour * 62 },
  { id: "c22", title: "周报自动汇总", agentId: "assistant", messages: [], updatedAt: now - hour * 66 },
  { id: "c23", title: "竞品功能矩阵对比", agentId: "research", messages: [], updatedAt: now - hour * 78 },
  { id: "c24", title: "留存漏斗拆解", agentId: "data", messages: [], updatedAt: now - hour * 84 },
  { id: "c25", title: "React 渲染性能优化", agentId: "coder", messages: [], updatedAt: now - hour * 90 },
  { id: "c26", title: "术语表统一校对", agentId: "translator", messages: [], updatedAt: now - hour * 96 },
  { id: "c27", title: "品牌 slogan 头脑风暴", agentId: "writer", messages: [], updatedAt: now - hour * 104 },
  { id: "c28", title: "股权结构说明", agentId: "legal", messages: [], updatedAt: now - hour * 112 },
  { id: "c29", title: "季度预算复盘", agentId: "finance", messages: [], updatedAt: now - hour * 120 },
  { id: "c30", title: "绩效面谈提纲", agentId: "hr", messages: [], updatedAt: now - hour * 130 },
  { id: "c31", title: "SEO 关键词规划", agentId: "marketing", messages: [], updatedAt: now - hour * 140 },
  { id: "c32", title: "灰度发布方案", agentId: "devops", messages: [], updatedAt: now - hour * 150 },
  { id: "c33", title: "设计系统 token 梳理", agentId: "design", messages: [], updatedAt: now - hour * 160 },
  { id: "c34", title: "数据备份策略", agentId: "database", messages: [], updatedAt: now - hour * 170 },
  { id: "c35", title: "渗透测试报告解读", agentId: "security", messages: [], updatedAt: now - hour * 180 },
  { id: "c36", title: "新人入职培训清单", agentId: "education", messages: [], updatedAt: now - hour * 190 },
]
